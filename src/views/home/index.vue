    ...
    <div class="chat-box">
      <div class="left-list">
        <div class="header">
          ...
          <div class="profile">
            <div class="name">我<span style="color: #fefefe; font-size: .9rem">（在线）</span></div>
            <span class="name" style="font-size: 1rem; color: #aaa; top: .3rem">聊天名称：{{ user.username }}</span>
          </div>
        </div>
        ...
        <div class="customer-list">
          <el-scrollbar style="height:100%; width: 100%;" class="menu-horizontal-scrollbar">
            ...
            <div class="list" v-for="items in outlineUserList" @click="connectWebsocketInFace(items)">
              <el-avatar :size="50" :src="src" fit="cover" class="avatar" style="background: #000"></el-avatar>
      ...
      <div class="right-list">
        ...
        <div class="input-box">
          <div class="submit" align="right">
            <el-button type="success" size="small" style="margin-right: .5rem" @click="sendContent">发送</el-button>
          </div>
